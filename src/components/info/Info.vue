...
<div class="info">
  <div class="box">
    <pic-box :src="info.fileDbName" :id="info.id" :nickname="info.fileName"></pic-box>
    <div class="desc" @click="goDetailPage(info)">
      {{info.desc}}
    </div>
    <bottom-bar :nickname="info.fileName" :avatar="info.avatar" :time="info.time" :userid="info.userid"></bottom-bar>
  </div>
</div>
</template>
